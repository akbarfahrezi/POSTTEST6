...
public final class posttest6 {
 static InputStreamReader isr = new InputStreamReader(System.in);
    ...
    static ArrayList<filter> listFilter = new ArrayList<>();
     ...
     // static method
    public static void jenisTembakau()
    {
        System.out.println("Pilih Jenis Tembakau :");
        System.out.println("1. Tambah Tembakau Kretek");
        System.out.println("2. Tambah Tembakau Filter");
